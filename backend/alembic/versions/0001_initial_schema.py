...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("tunnel_network", sa.String(64), nullable=True),
        sa.Column("public_key", sa.String(64), nullable=True),
        sa.Column("private_key", sa.String(64), nullable=True),
        sa.Column("preshared_key", sa.String(64), nullable=True),
        sa.Column("raw_conf", sa.Text, nullable=True),
        sa.Column("client_address", sa.String(64), nullable=True),
        sa.Column("client_dns", sa.String(256), nullable=True),
        sa.Column("client_allowed_ips", sa.String(256), nullable=True),
        sa.Column("client_keepalive", sa.Integer, nullable=True),
        sa.Column("client_obf_jc", sa.Integer, nullable=True),
        sa.Column("client_obf_jmin", sa.Integer, nullable=True),
        sa.Column("client_obf_jmax", sa.Integer, nullable=True),
        sa.Column("client_obf_s1", sa.Integer, nullable=True),
        sa.Column("client_obf_s2", sa.Integer, nullable=True),
        sa.Column("client_obf_s3", sa.Integer, nullable=True),
        sa.Column("client_obf_s4", sa.Integer, nullable=True),
        sa.Column("client_obf_h1", sa.Integer, nullable=True),
        sa.Column("client_obf_h2", sa.Integer, nullable=True),
        sa.Column("client_obf_h3", sa.Integer, nullable=True),
        sa.Column("client_obf_h4", sa.Integer, nullable=True),
        sa.Column(
            "status",
            sa.Enum(
        ...
        sa.Column("is_geoip", sa.Boolean, nullable=False, server_default="0"),
