...
class GatewaySettings(Base):
    ...
    gateway_enabled: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    dns_intercept_enabled: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    experimental_nftables: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    ...
    backend_restart_enabled: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    backend_restart_interval_days: Mapped[int] = mapped_column(Integer, default=7, nullable=False)
    backend_restart_time: Mapped[str] = mapped_column(String(5), default="04:00", nullable=False)
    backend_restart_last_requested_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
